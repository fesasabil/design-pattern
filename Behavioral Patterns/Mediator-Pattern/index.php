...
class BookMediator
{
    ...
    function __construct($authort_in, $title_in)
    {
        $this->authorObject = new BookAuthorColleague($authort_in,$this);
...
class BookAuthorColleague extends BookColleague
{
    ...
    function __construct($authort_in, $mediator_in)
    {
        $this->author = $authort_in;
